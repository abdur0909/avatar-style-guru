...
const avatarOptions: AvatarOption[] = [
  ...
  { id: '9', emoji: '🧑‍🎤', name: 'Musician', category: 'Creative', available: true },
  { id: '10', emoji: '👩‍🔬', name: 'Scientist', category: 'Professional', available: true },
  { id: '11', emoji: '👨‍🍳', name: 'Chef', category: 'Creative', available: true },
  ...
  { id: '16', emoji: '👩‍🚀', name: 'Astronaut Woman', category: 'Creative', available: true },
  { id: '17', emoji: '👨‍🚀', name: 'Astronaut Man', category: 'Creative', available: true },
  { id: '18', emoji: '👩‍🎭', name: 'Artist Woman', category: 'Creative', available: false },
  { id: '19', emoji: '👨‍🎭', name: 'Artist Man', category: 'Creative', available: false },
  { id: '20', emoji: '🧑‍💼', name: 'Business Person', category: 'Professional', available: false },
];
              ...
              {avatars.map((avatar) => (
                <CarouselItem key={avatar.id} className="pl-2 md:pl-4 basis-1/3 md:basis-1/4 lg:basis-1/5">
                  <div
                    ...
                    className={cn(
                      "relative bg-white rounded-xl p-3 border-2 cursor-pointer",
                  ...
                  >
                    <div className="text-center">
                      <div className="text-2xl md:text-3xl mb-2">{avatar.emoji}</div>
